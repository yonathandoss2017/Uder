...
enum PermisoEnum {
    ...
    REACTIVAR_PERFIL = 27,
    OBTENER_PERFILES = 28,
    ALTA_UBICACION = 29,  // Corregido valor duplicado
    BAJA_UBICACION = 30,
    ...
    MODIFICAR_MODELO = 47,
    BAJA_MODELO = 48,
    ALTA_FUNCIONALIDAD = 49,
    OBTENER_FUNCIONALIDADES = 50,
    MODIFICAR_FUNCIONALIDAD = 51,
    BAJA_FUNCIONALIDAD = 52,
    ASIGNAR_FUNCIONALIDAD = 53,
    REVOCAR_FUNCIONALIDAD = 54,
    AGREGAR_PERMISO_FUNCIONALIDAD = 55,
    REVOCAR_PERMISO_FUNCIONALIDAD = 56
}
